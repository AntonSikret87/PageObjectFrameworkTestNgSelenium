...
public class CheckoutPage extends BasePage {
    ...
    public static final String DROPDOWN_VALUE_BY_NAME_PATTERN = "//li[text()='%s']";
...
/*        Select select = new Select(driver.findElement(countryDropDown));
        ...
        WebElement dropDownValue = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath(String.format(DROPDOWN_VALUE_BY_NAME_PATTERN, countryName))));
...
/*        Select select = new Select(driver.findElement(stateDropDown));
    ...
    public CheckoutPage enterUserName(String username){
        wait.until(ExpectedConditions.elementToBeClickable(usernameFld)).sendKeys(username);
        return this;
    }

    public CheckoutPage enterPassword(String password){
        wait.until(ExpectedConditions.elementToBeClickable(passwordFld)).sendKeys(password);
        return this;
    }
